...
```text
├── main.py              # FastAPI 後端伺服器與 Dijkstra 核心演算法
├── tool_svg2json.py     # SVG 圖資自動化萃取與正規化 Parsing 腳本
├── index.html           # 前端 Canvas 輕量化渲染與互動控制面板
├── map_data.json        # 經過解析、吸附處理的結構化圖資核心 (Nodes/Edges)
